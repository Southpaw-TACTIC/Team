...
#define SBK_QTNETWORK_QHASH_QSTRING_QVARIANT_IDX                     5 // QHash<QString, QVariant >
#define SBK_QTNETWORK_QPAIR_QSTRING_QSTRING_IDX                      6 // QPair<QString, QString >
#define SBK_QTNETWORK_QLIST_QPAIR_QSTRING_QSTRING_IDX                7 // const QList<QPair<QString, QString > > &
...
#define SBK_QTNETWORK_QPAIR_QHOSTADDRESS_INT_IDX                     11 // const QPair<QHostAddress, int > &
#define SBK_QTNETWORK_QLIST_QSSLCERTIFICATE_IDX                      12 // QList<QSslCertificate >
#define SBK_QTNETWORK_QLIST_QSSLCIPHER_IDX                           13 // QList<QSslCipher >
